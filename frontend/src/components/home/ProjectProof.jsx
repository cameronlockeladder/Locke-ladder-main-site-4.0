...
import { PROOF, REVIEW_QUOTES } from "@/data/content";

export const ProjectProof = () => {
  const [feature, ...rest] = PROOF;
  return (
      ...
      <div className="shell py-20 md:py-28">
        <Reveal>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-12 md:items-end">
            ...
            <p className="text-base leading-relaxed text-paper/60 md:col-span-4">
              The best proof is specific. Named people, real jobs, and concrete details, not slogans.
            </p>
          </div>
        </Reveal>
        ...
        <Reveal delay={0.05}>
          <div className="mt-14 grid grid-cols-1 gap-8 md:grid-cols-12 md:items-center md:gap-12">
            ...
            <div className="md:col-span-5">
              ...
              <h3 className="font-display mt-3 text-2xl font-medium tracking-tight text-paper md:text-3xl">
                {feature.label}
              </h3>
          ...
          {rest.map((p, i) => (
            <Reveal key={p.label} delay={0.05 + i * 0.05}>
              <article>
                ...
                <h3 className="font-display mt-3 text-xl font-medium tracking-tight text-paper md:text-2xl">
                  {p.label}
                </h3>
        ...
        <Reveal delay={0.05}>
          <div className="mt-20 grid grid-cols-1 gap-10 border-t border-line pt-12 md:grid-cols-12 md:gap-12">
            <div className="md:col-span-4">
              ...
              />
              <p className="font-display mt-5 text-2xl tracking-tight text-paper md:text-3xl">
            ...
            <div className="grid grid-cols-1 gap-8 md:col-span-8 md:grid-cols-2">
              {REVIEW_QUOTES.map((r) => (
                <blockquote key={r.author} className="border-l-2 border-line pl-5">
                  ...
                  <cite className="mt-3 block text-xs uppercase not-italic tracking-eyebrow text-copper">
                    {r.author}
                  </cite>
                </blockquote>
              ))}
